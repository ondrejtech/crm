...
class ComingWorkPolicy
{
     ...
     *
     * @param  \App\Models\User  $user
     * @param  \App\Models\ComingWork  $comingWork
     * @return bool
     */
    public function view(User $user, ComingWork $comingWork): bool
    {
     ...
     * @return bool
     */
    public function update(User $user, ComingWork $comingWork): bool
    {
     ...
     * @return bool
     */
    public function delete(User $user, ComingWork $comingWork): bool
    {
     ...
     * @return bool
     */
    public function forceDelete(User $user, ComingWork $comingWork): bool
    {
     ...
     * @return bool
     */
    public function restore(User $user, ComingWork $comingWork): bool
    {
     ...
     * @return bool
     */
    public function replicate(User $user, ComingWork $comingWork): bool
    {
